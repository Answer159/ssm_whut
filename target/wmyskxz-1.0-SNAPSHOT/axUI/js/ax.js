    ...
    var AxScrollClass = function(myopt, me) {
        ...
        this.init = function() {
            ...
            if (!self.ispage || !cap.isieold) {
                ...
                cursor.css({ position: "relative", top: 0, float: "right", width: opt.cursorwidth, height: 0, "background-color": opt.cursorcolor, border: opt.cursorborder, "background-clip": "padding-box", "-webkit-border-radius": opt.cursorborderradius, "-moz-border-radius": opt.cursorborderradius, "border-radius": opt.cursorborderradius });
                ...
                if (opt.boxzoom && !self.ispage && !cap.isieold) {
                    ...
                    self.zoom = $(zoom);
                    self.zoom.css({ cursor: "pointer", zIndex: self.zindex, backgroundImage: "url(" + opt.scriptpath + "zoomico.png)", height: 18, width: 18, backgroundPosition: "0 0" });
...
if (platformIs == 'pc') { $(".ax-scroll").axScroll(); }
/* Popup */
