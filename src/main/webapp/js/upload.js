    ...
    $(".uploadImgs-add").click(function() {
        ...
        lastInput.bind("change", function() {
            if (lastInput[0].files) { //谷歌 IE10以上          
                ...
                var upImgs = "<div class='show-img-div2'><span><img src='../images/close.png' /></span><img class='ie-imgshow' src='./images/null.png' /></div>";
                $("#labelId").before(upImgs);
                lastInput[0].select();
...
function createPreDiv() {
    var divStr = '<div class="imgs-bg"> <div class="middle"> <div class="middle-img"> <img src=\"\"></div><div class="left"><img src="./images/left.png"></div><div class="right"> <img src="./images/right.png"></div><p>\xD7</p></div></div>';
    $('body').append(divStr);
